...
def codigoBotton():
      ...
      while True:
        ...
        movement2 = tabla_switch.get(num2)
        pyautogui.keyDown(movement1)
        pyautogui.keyDown(movement2) 
        time.sleep(random.randint(1,3))
        pyautogui.keyUp(movement1)
        pyautogui.keyUp(movement2)
...
def main():
  ...
  mibotonEmpezar = Button(miFrame, text= "Go dinner", height=3, width=40, command= lanzarHilo)
